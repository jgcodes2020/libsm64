...
namespace libsm64 {
  ...
  public:
    ...
    /**
     * @brief Sets the current input.
     * 
     * @param input an input_frame with the needed input
     */
    void set_input(input_frame input) {
      *locate<uint16_t>("gControllerPads", 0) = input.m_buttons;
      *locate<uint8_t>("gControllerPads", 2) = input.m_stick_x;
      *locate<uint8_t>("gControllerPads", 3) = input.m_stick_y;
    }
